...
task_router.post('/:courseId/tasks', authCheckTask, taskController.createTaskForCourse);
task_router.put('/:courseId/tasks/:taskId/edit', authCheckTask, taskController.updateTaskForCourse);
...
task_router.post('/:courseEnrollmentId/tasks/:taskEnrollmentId/submit', authCheckTask, taskController.submitCourseTask);
