...
import {courseCreateValidation, courseUpdateValidation, taskCreateValidation} from '../utils/validations';
...
course_router.put('/task/:courseId', authCheck, taskCreateValidation, courseController.createTaskForCourse);
